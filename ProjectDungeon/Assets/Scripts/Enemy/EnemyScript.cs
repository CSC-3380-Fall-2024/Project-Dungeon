...
public class EnemyScript : MonoBehaviour
{
    ...
    [SerializeField]
    public double Health;// health stat for the enemy

    [SerializeField]
    public double defense; // Def stat of the enemy

    [SerializeField]
    public double speed; // Speed stat of enemy

    [SerializeField]
    public int dropExp; // amount of exp enemy will drop once defeated
